...
#figure(
  ...
  caption: [Сирови сигнали записа SpO2HR (засићеност крви кисеоником и срчани ритам) за Испитаника 1, током целог протокола; вертикалне линије означавају границе фаза.]
) <fig:raw-spo2hr>
...
За сваки прозор рачуна се скуп обележја у временском и фреквенцијском домену, засебно за пет сигнала: магнитуду убрзања (изведену из три осе акцелерометра), електродермалну активност, температуру коже, срчани ритам и засићеност крви кисеоником.
...
Стандардне мере варијабилности срчаног ритма, попут RMSSD и SDNN, не могу се израчунати над овим скупом података, пошто он садржи само унапред усредњен срчани ритам у откуцајима у минути на 1Hz, без сировог PPG таласног облика из ког би се детектовао сваки појединачни откуцај и израчунао низ RR интервала. Уместо стандардних HRV мера рачунају се показатељи сукцесивних разлика суседних вредности срчаног ритма у прозору: корен средње квадратне вредности, стандардна девијација, минимум, максимум, медијана и нагиб тренда низа разлика.
